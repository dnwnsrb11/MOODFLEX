...
from .models import Collection, Movie, Cast, Crew, Emotion, Genre, Person, Review, ReviewComment 
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Review
        fields = ('id', 'content', 'rating', 'likes_count', 'is_liked','create_review','nickname', 'user', 'movie', 'emotion', 'movie_title', 'poster_path')
...
class CollectionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Collection
        fields = '__all__'
        read_only_fields = ('user', 'vote_average', 'movies')